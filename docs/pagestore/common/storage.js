...
let CbStorage = function (storageName, options = {}) {
    // ommiting storageName creates a non persistent local object
    // but save callback is still called
    //options
    //  dbStores: ["name", "name"]
    //  arraySets: ["key", key]

    let dbStores = options.dbStores;
    let saveCallback = storage => { };
    ...
    this.require = function (key, defaultValue) {
        if (storage[key] == undefined) {
            ...
            //You have this defined, check you have next level defined
    ...
    this.assignStorage = function (obj) {
